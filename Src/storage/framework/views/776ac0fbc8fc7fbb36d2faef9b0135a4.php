...
<?php $__env->startSection('title', 'Byte Bites - Home'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="wilma-hero-section" id="home">
        <div class="wilma-hero-content">
            ...
            <a class="btn wilma-btn-custom" href="<?php echo e(url('/products')); ?>">Menu</a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="<?php echo e(asset('assets/resturant.jpg')); ?>" alt="Restaurant Interior" class="wilma-about-image">
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-center">
                    <img src="<?php echo e(asset('assets/dish-removebg-preview.png')); ?>" alt="Chef Special Dish"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nadaa\OneDrive\Desktop\Web_Final_Prpject\Src\resources\views/home.blade.php ENDPATH**/ ?>